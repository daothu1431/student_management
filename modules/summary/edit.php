        ...
        <div class="row">
                    ...
                    <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="score_HK1" id="" class="form-control score" value="<?php echo old('score_HK1', $old); ?>">
                                    <?php echo form_error('nameStudent', $errors, '<span class="error">', '</span>'); ?>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="score_HK2" id="" class="form-control score" value="<?php echo old('score_HK2', $old); ?>">
                                    <?php echo form_error('nameStudent', $errors, '<span class="error">', '</span>'); ?>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="total_score" id="average" class="form-control" value="<?php echo old('total_score', $old); ?>">
                ...
                <div class="col-4">
                    ...
                    <div class="form-group">
                            ...
                            <textarea name="comment" id="" class="form-control" rows="5"><?php echo old('comment', $old) ?></textarea>
                    </div>
            ...
            <div class="col">
                <div class="btn-row">
                    ...
                    <input type="hidden" name="id" value="<?php echo $summaryId; ?>">
                </div>
            </div>
        </form>
    </div>
